...
public class InrontoMetricTest {
    ...
    public InrontoMetricTest(int inputNumber1, int inputNumber2, int expectedResult) {
    ...
    @Test
    public void inrontoMetric() {
        System.out.println("Parameterized Number expected is : " + expectedResult);
        Assert.assertEquals(expectedResult,qualityMetrics.inrontoMetric(inputNumber1,inputNumber2));
    }
}
