...
public class AnontoMetricTest {
    ...
    public AnontoMetricTest(int inputNumber1, int inputNumber2, int expectedResult) {
    ...
    @Test
    public void anontoMetric() {
        System.out.println("Parameterized Number expected is : " + expectedResult);
        Assert.assertEquals(expectedResult,qualityMetrics.anontoMetric(inputNumber1,inputNumber2));
    }
}
