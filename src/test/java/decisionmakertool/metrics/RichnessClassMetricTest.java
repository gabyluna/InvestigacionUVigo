...
public class RichnessClassMetricTest {
    ...
    public RichnessClassMetricTest(int inputNumber1, int inputNumber2, int expectedResult) {
    ...
    @Test
    public void richnessClassMetric() {
        System.out.println("Parameterized Number expected is : " + expectedResult);
        Assert.assertEquals(expectedResult,qualityMetrics.richnessClassMetric(inputNumber1,inputNumber2));
    }
}
