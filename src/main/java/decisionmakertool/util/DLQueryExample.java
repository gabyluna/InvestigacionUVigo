...
@SuppressWarnings("javadoc")
    public static void main(String[] args) throws OWLOntologyCreationException, UnsupportedEncodingException, IOException {
        ...
        String query="Vulnerability that affectTo some (isLocatedIn some (Location and isOfEasyPhysicalAccess value \"yes\"))";
       // String query="way";
